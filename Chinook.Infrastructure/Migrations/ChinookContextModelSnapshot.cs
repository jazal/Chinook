...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chinook.Core.Models.ChinookUser", b =>
                {
            ...
            modelBuilder.Entity("Chinook.Core.Models.InvoiceLine", b =>
                {
            ...
            modelBuilder.Entity("Chinook.Core.Models.UserPlaylist", b =>
                {
            ...
            modelBuilder.Entity("Chinook.Core.Models.Album", b =>
                {
                    b.HasOne("Chinook.Core.Models.Artist", "Artist")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Chinook.Core.Models.Customer", b =>
                {
                    b.HasOne("Chinook.Core.Models.Employee", "SupportRep")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("Chinook.Core.Models.Employee", b =>
                {
                    b.HasOne("Chinook.Core.Models.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Chinook.Core.Models.Invoice", b =>
                {
                    b.HasOne("Chinook.Core.Models.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Chinook.Core.Models.InvoiceLine", b =>
                {
                    b.HasOne("Chinook.Core.Models.Invoice", "Invoice")
                        .WithMany("InvoiceLines")
                        .HasForeignKey("InvoiceId")
                        .IsRequired();

                    b.HasOne("Chinook.Core.Models.Track", "Track")
                        .WithMany("InvoiceLines")
            ...
            modelBuilder.Entity("Chinook.Core.Models.Track", b =>
                {
                    b.HasOne("Chinook.Core.Models.Album", "Album")
                        .WithMany("Tracks")
                        .HasForeignKey("AlbumId");

                    b.HasOne("Chinook.Core.Models.Genre", "Genre")
                        .WithMany("Tracks")
                        .HasForeignKey("GenreId");

                    b.HasOne("Chinook.Core.Models.MediaType", "MediaType")
                        .WithMany("Tracks")
            ...
            modelBuilder.Entity("Chinook.Core.Models.UserPlaylist", b =>
                {
                    b.HasOne("Chinook.Core.Models.Playlist", "Playlist")
                        .WithMany("UserPlaylists")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chinook.Core.Models.ChinookUser", "User")
                        .WithMany("UserPlaylists")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Chinook.Core.Models.ChinookUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlaylistTrack", b =>
                {
                    b.HasOne("Chinook.Core.Models.Playlist", null)
                        .WithMany()
                        .HasForeignKey("PlaylistId")
                        .IsRequired();

                    b.HasOne("Chinook.Core.Models.Track", null)
                        .WithMany()
                        .HasForeignKey("TrackId")
                        .IsRequired();
                });
